...
| **POST** | **`/api/voice/transcribe`** | **Aufnahme transkribieren, ohne zu speichern (multipart, Felder `audio`, `page_id`, `template_id`); liefert Transkript, aufbereiteten Text als ProseMirror-Dokument, Überschriftsvorschlag und Notizbuch (FR-VOICE-02/03/08)** |
