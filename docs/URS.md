...
| **POST** | **`/api/voice/notes`** | **Aus einer Aufnahme direkt eine Notiz anlegen (multipart, Felder `audio`, `template_id`, optional `lat`/`lon`/`accuracy`); liefert die neue Seite (FR-VOICE-01–04/08, FR-NOTE-25)** |
