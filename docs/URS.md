...
| **GET** | **`/api/voice/templates`** | **Wählbare Diktier-Vorlagen: globale und eigene, global zuerst (FR-VOICE-08/09)** |
| **GET/POST** | **`/api/profile/voice-templates`** | **Eigene Vorlagen auflisten bzw. anlegen (`name`, `instruction`, `vocabulary`) (FR-VOICE-09)** |
