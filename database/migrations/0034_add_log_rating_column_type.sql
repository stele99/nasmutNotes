...
-- Spaltendefinition wird deshalb mit dem zusätzlichen Typ "rating" neu
-- aufgebaut - wie zuvor schon für "user" (siehe 0029).
...
CREATE TABLE log_columns_rebuilt (
    ...
    name        TEXT NOT NULL,
    type        TEXT NOT NULL CHECK (type IN ('text', 'location', 'time', 'hours', 'number', 'money', 'rating', 'user')),
