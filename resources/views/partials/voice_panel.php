...
<div x-show="isVoiceBusy() || voiceError || voiceNotice" x-cloak class="voice-panel<?php echo empty($voicePanelBare) ? ' mt-3' : ' voice-panel-bare'; ?>">
    <div x-show="voiceStatus === 'recording' || voiceStatus === 'paused'" x-cloak class="flex flex-wrap items-center gap-x-3 gap-y-2">
        ...
        <div class="ml-auto flex flex-wrap gap-2">
            ...
            <button type="button" x-show="voiceStatus === 'recording'" @click="pauseVoice" class="btn btn-quiet px-3 py-1.5 text-sm">Pause</button>
            <button type="button" x-show="voiceStatus === 'paused'" x-cloak @click="resumeVoice" class="btn btn-quiet px-3 py-1.5 text-sm"><span x-icon="play"></span>Fortsetzen</button>
