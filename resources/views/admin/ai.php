<div class="mx-auto max-w-6xl px-5 py-10 sm:px-10 sm:py-14" x-data="adminDashboard">
    ...
    <div class="lg:grid lg:grid-cols-[13rem_minmax(0,1fr)] lg:gap-8">
        ...
        <div id="ki-vorlagen" class="document-surface mb-8 scroll-mt-6 p-5 sm:p-6">
            ...
            <?php /* Zusammengeklappt steht nur der Name da; die Anweisungen sind
                     mehrere Absätze lang und würden die Seite sonst sprengen. */ ?>
            <div x-show="voiceTemplates.length > 0" x-cloak class="mt-5 space-y-1">
                    ...
                    <div class="rounded-lg border" style="border-color: var(--color-border);">
                        <div class="flex items-center gap-2 px-3 py-2">
                            ...
                            <span class="flex shrink-0 gap-2">
                                <button type="button" @click="startEditVoiceTemplate(template)" :disabled="busy" class="text-xs font-medium" style="color: var(--color-text-muted);">Bearbeiten</button>
                                <button type="button" @click="deleteVoiceTemplate(template)" :disabled="busy" class="text-xs font-medium" style="color: var(--color-danger);">Entfernen</button>
                            </span>
                        </div>
